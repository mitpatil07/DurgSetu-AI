    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Handle Django Rest Framework error object (could be an object with keys or a string)
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-8">
            <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse border border-slate-100">
                ...
                {/* Brand Side (Right on Desktop, Top on Mobile) */}
                <div className="md:w-5/12 bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 p-10 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 -ml-16 -mt-16 w-64 h-64 rounded-full bg-white/10 blur-2xl"></div>
                    <div className="absolute bottom-0 right-0 -mr-16 -mb-16 w-80 h-80 rounded-full bg-orange-400/20 blur-3xl"></div>
                    ...
                    <div className="relative z-10 mb-10 md:mb-0">
                        ...
                        <p className="text-orange-100 text-lg leading-relaxed mb-8">
                            Register an administrator account to start monitoring fort health, verifying structural changes, and receiving critical AI alerts.
                        </p>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 bg-black/10 backdrop-blur-md rounded-xl p-3 border border-white/10">
                                ...
                                <span className="text-sm font-medium text-orange-50">Secure Access Role</span>
                            </div>
                            <div className="flex items-center gap-3 bg-black/10 backdrop-blur-md rounded-xl p-3 border border-white/10">
                                <Mail className="w-5 h-5 text-orange-200" />
                                <span className="text-sm font-medium text-orange-50">Automated Alert Delivery</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="md:w-7/12 p-10 sm:p-14 flex flex-col justify-center bg-white">
                    <div className="max-w-md w-full mx-auto">
                        <div className="mb-10">
                            ...
                            <p className="text-slate-500 font-medium">Set up your admin profile credentials below.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">Email <span className="text-slate-400 font-normal ml-1">(For Alert Notifications)</span></label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-orange-500 text-slate-400">
                        ...
                        <div className="mt-10 pt-6 border-t border-slate-100 text-center text-sm font-medium text-slate-500 flex flex-col items-center gap-4">
                            <p>
                                ...
                                <button onClick={() => navigate('/login')} className="text-orange-600 hover:text-orange-700 font-bold transition-colors">
                                    Log in
                                </button>
                            </p>
